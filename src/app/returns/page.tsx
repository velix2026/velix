  ...
  const policies = [
    {
      ...
      icon: "⏱️",
      content: "حقك تستبدل أو تسترجع المنتج خلال ١٤ يوم من تاريخ استلام الطلب. عندك وقت كافي تجرب المنتج وتتأكد إنه مناسب ليك."
    },
    {
      number: "٢",
      title: "شروط الاستبدال والاسترجاع",
      icon: "✅",
      content: "المنتج يكون غير مستخدم ومجربش يتغسل، في حالته الأصلية مع البطاقات والتغليف. لازم ترفق فاتورة الشراء مع الطلب."
    },
    {
      number: "٣",
      title: "رسوم الاستبدال",
      icon: "💰",
      content: "الاستبدال والاسترجاع مجاني تماماً. مش هتدفع أي رسوم إضافية، راحتك هي أولويتنا."
    },
    {
      number: "٤",
      title: "كيفية الاستبدال",
      icon: "📱",
      content: "تواصل معانا على واتساب، هنسق معاك عملية الاستبدال أو الاسترجاع في أسرع وقت."
    },
    {
      number: "٥",
      title: "منتجات التخفيضات (العروض)",
      icon: "🏷️",
      content: "المنتجات اللي عليها تخفيضات وعروض، تقدر تستبدلها خلال ٣ أيام من تاريخ الاستلام بس. الاسترجاع غير متاح للمنتجات المخفضة."
    }
  ];
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        >
          ...
          <p className="text-black/60 font-bold text-base max-w-2xl mx-auto">
            بنضمن رضاك عن منتجاتنا، لو مش عجبك المنتج لأي سبب، عندك حق تستبدله أو تسترجعه
          </p>
        </motion.div>
          ...
          {policies.map((policy, idx) => (
            <motion.div
              ...
              className={`group relative bg-white rounded-2xl p-6 border transition-all duration-300 hover:-translate-y-1 ${
                idx === 4 
                  ? 'border-amber-200 bg-amber-50/30 hover:shadow-amber-100' 
                  : 'border-black/10 hover:shadow-xl'
              }`}
            >
              <div className="flex items-start gap-5">
                {/* Number Circle - بدون خلفية مربعة، دائرة فقط */}
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h2 className={`text-xl font-black ${
                      idx === 4 ? 'text-amber-800' : 'text-black'
                    }`}>
                      {policy.title}
                    </h2>
                  </div>
                  <p className={`font-bold leading-relaxed ${
                    idx === 4 ? 'text-amber-700/80' : 'text-black/70'
                  }`}>
                    {policy.content}
                  </p>
                </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-amber-700/80 font-bold text-sm leading-relaxed">
                المنتجات المخفضة (عروض التخفيضات) تقبل الاستبدال فقط خلال ٣ أيام من تاريخ الاستلام. 
                المنتجات الداخلية (ملابس داخلية) لا تقبل الاستبدال لأسباب صحية ولضمان سلامة الجميع.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-white rounded-2xl p-5 border border-black/10 text-center">
            ...
            <div className="mt-2 text-emerald-600 font-black text-xs">بدون رسوم</div>
          </div>
          <div className="bg-amber-50 rounded-2xl p-5 border border-amber-200 text-center">
            <div className="text-3xl mb-2">🏷️</div>
            <h3 className="font-black text-amber-800 mb-2">منتجات التخفيضات</h3>
            <p className="text-amber-700/70 font-bold text-sm">استبدال فقط خلال ٣ أيام</p>
            <div className="mt-2 text-amber-600 font-black text-xs">استرجاع غير متاح</div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-6 bg-linear-to-r from-emerald-50 to-green-50 rounded-2xl p-6 text-center border border-emerald-200"
        >
          ...
          <h3 className="text-xl font-black text-emerald-700 mb-2">رضاك مضمون ١٠٠%</h3>
