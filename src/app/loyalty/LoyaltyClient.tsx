...
const faqs = [
  ...
  { q: 'إزاي أستبدل النقاط؟', a: 'لما تكمل طلبك، هتقدر تدخل رقم تليفونك وتشوف نقاطك. لو معاك ١٠٠ نقطة أو أكتر، تقدر تستبدلهم بخصم. كل ١٠٠٠ نقطة = ١٠ جنيه خصم.' },
        ...
        <div className="mb-12 bg-rose-gold/5 rounded-2xl p-6 md:p-8 border border-rose-gold/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              { step: '٣', title: 'استبدل', desc: `كل ${toArabicNumber(1000)} نقطة = ${toArabicNumber(10)} جنيه خصم` },
            ].map((item, i) => (
              <motion.div
                key={i}
          ...
          <div className="text-center mt-6">
            <div className="inline-block bg-white rounded-xl px-4 py-2 border border-rose-gold/20 text-sm font-bold text-black">
              {toArabicNumber(1000)} نقطة = {toArabicNumber(10)} جنيه خصم
            </div>
          </div>
        </div>
