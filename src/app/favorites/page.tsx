...
export default function FavoritesPage() {
  ...
  const [orderModalProduct, setOrderModalProduct] = useState<{
    id: number;
    name: string;
    price: number;
    mainImage: string;
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-16">
      <div className="container mx-auto px-4">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-4">المفضلة</h1>
      ...
      {orderModalProduct && (
        <OrderModal
          ...
          product={{
            ...
            mainImage: orderModalProduct.mainImage,
            quantity: orderModalProduct.quantity,
          }}
