...
export const metadata = {
  ...
  keywords: ["تيشرت رجالي قطن مصري", "هودي شتوي مصر", "شروال رياضي رجالى", "ملابس شبابي مصر", "VELIX", "ستريت وير مصر عروض", "ملابس مصرية فاخرة", "براند ملابس مصري فخم", "اشترى ملابس اون لاين مصر", "تيشرتات اوفر سايز مصر"],
  openGraph: {
    title: "المنتجات | VELIX - تشكيلة كاملة",
