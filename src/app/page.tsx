...
export const metadata = {
  ...
  keywords: [
    ...
    "هودي شتوي تقيل مصر 2026",
    "شروال رياضي رجالى قطيفة",
    "ملابس شبابي مصر فخمة",
    "ستريت وير مصر عروض",
    "صناعة مصرية 100%",
    "اشترى ملابس اون لاين مصر احسن موقع",
    "تيشرتات مصرية فاخرة رجالي",
    "براند ملابس مصري فخم شبابي",
  ],
  openGraph: {
    title: "VELIX | براند ملابس مصري فاخر",
