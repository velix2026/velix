  ...
  const policies = [
    {
      ...
      title: "مناطق التوصيل",
      icon: "📍",
      content: "بنوصل لجميع محافظات الجمهورية. الحمدلله الشغل بقى متاح في كل مصر، من إسكندرية لأسوان، ومن البحر للأقصر."
    },
    {
      number: "٢",
      title: "الشحن مجاني",
      icon: "🎉",
      content: "الشحن مجاني بالكامل لجميع الطلبات في جميع محافظات مصر. من غير أي رسوم إضافية، اطلب دلوقتي واستلم مجاناً."
    },
    {
      number: "٣",
      title: "مدة التوصيل",
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            ...
            <p className="text-black/60 font-bold text-base max-w-2xl mx-auto">
              بنوصل طلباتك لجميع محافظات مصر بأسرع وقت وبأعلى جودة
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-emerald-600/80 font-bold">
              لجميع الطلبات في جميع محافظات مصر. اطلب دلوقتي واستلم مجاناً
            </p>
            <Link
              href="/products"
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {["جميع محافظات مصر", "القاهرة", "الإسكندرية", "الجيزة", "الدلتا", "الصعيد", "القناة"].map((city, idx) => (
                <span
                  key={idx}
                  className="px-4 py-2 bg-black/5 border border-black/10 rounded-full text-black font-bold text-sm"
                >
                  {city}
                </span>
              ))}
            </div>
            <p className="text-emerald-600 text-sm mt-4 font-bold flex items-center justify-center gap-1">
              <span>✅</span> التوصيل متاح لجميع محافظات مصر
            </p>
          </motion.div>
