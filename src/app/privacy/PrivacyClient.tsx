...
export default function PrivacyClient() {
  const policies = [
    {
      ...
      icon: "🔒",
      content: "بنقوم بجمع المعلومات اللي بتقدمها عند طلب المنتج: الاسم، رقم الهاتف، العنوان. وبنستخدمها بس عشان نجهز طلبك ونتواصل معاك."
    },
    {
      number: "٢",
      title: "إزاي بنستخدم معلوماتك",
      icon: "⚙️",
      content: "معلوماتك بتستخدم بس عشان نجهز طلبك، نوصله لعنوانك، ونتواصل معاك لو فيه أي استفسار. بنحافظ على خصوصيتك وما نستخدمش بياناتك في أي حاجة تانية."
    },
    {
      number: "٣",
      title: "حماية معلوماتك",
      icon: "🛡️",
      content: "أمان بياناتك هو أولويتنا. بنلتزم بحماية معلوماتك وما نشاركهاش مع أي طرف تالت. كل بياناتك محفوظة بشكل آمن."
    },
    {
      number: "٤",
      title: "حقوقك",
      icon: "📋",
      content: "حقك تطلب تعديل أو حذف بياناتك في أي وقت. تواصل معانا وبيتم تنفيذ طلبك في أسرع وقت."
    },
    {
      number: "٥",
      title: "التعديلات على السياسة",
      icon: "📝",
      content: "نحتفظ بالحق في تعديل سياسة الخصوصية في أي وقت. هيتم إخطارك بأي تغييرات مهمة."
    }
  ];
  ...
  const privacySchema = {
    ...
    "@type": "WebPage",
    "name": "سياسة الخصوصية - VELIX",
    "description": "سياسة خصوصية متجر VELIX - حماية البيانات والخصوصية",
    "url": "https://velix-eg.store/privacy",
    "mainEntity": {
      "@type": "PrivacyPolicy",
      "name": "سياسة الخصوصية VELIX",
      "text": "نحن في VELIX نلتزم بحماية خصوصية عملائنا وبياناتهم الشخصية"
    }
  };
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            <p className="text-black/60 font-bold">
              لو عندك أي استفسار عن بياناتك أو عايز تطلب تعديلها:
            </p>
            <a
