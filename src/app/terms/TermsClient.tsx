...
export default function TermsClient() {
  const terms = [
    {
      ...
      title: "قبول الشروط",
      icon: "📜",
      content: "باستخدامك لموقع VELIX، انت بتوافق على كل الشروط والأحكام المذكورة هنا. لو مش موافق، يبقى متستخدمش الموقع."
    },
    {
      number: "٢",
      title: "المنتجات والأسعار",
      icon: "🏷️",
      content: "بنحافظ على دقة المعلومات والصور، بس ممكن يحصل اختلافات بسيطة في الألوان بسبب إعدادات الشاشة. الأسعار اللي معروضة هي الأسعار النهائية، وأي رسوم إضافية بتظهر قبل إتمام الطلب."
    },
    {
      number: "٣",
      title: "الطلب والدفع",
      icon: "💳",
      content: "بمجرد تأكيد الطلب، بنعتبر إنك موافق على شراء المنتج بالسعر المحدد. الدفع عند الاستلام بالكاش، أو بأي طريقة دفع متاحة وقتها."
    },
    {
      number: "٤",
      title: "التوصيل",
      icon: "🚚",
      content: "بنوصل الطلبات لكل محافظات مصر. مدة التوصيل تقريبية وبتعتمد على منطقتك وظروف التوصيل."
    },
    {
      number: "٥",
      title: "الاستبدال والاسترجاع",
      icon: "🔄",
      content: "سياسة الاستبدال والاسترجاع متاحة خلال ١٤ يوم للمنتجات العادية، و٣ أيام للمنتجات المخفضة (استبدال بس). راجع سياسة الاستبدال والاسترجاع للتفاصيل."
    },
    {
      number: "٦",
      title: "الملكية الفكرية",
      icon: "©️",
      content: "كل المحتوى على الموقع (صور، نصوص، شعارات، تصاميم) ملك لـ VELIX ومينفعش تستخدمه من غير إذن كتابي."
    },
    {
      number: "٧",
      title: "تعديل الشروط",
  ...
  const termsSchema = {
    ...
    "@type": "WebPage",
    "name": "شروط الاستخدام - VELIX",
    "description": "شروط استخدام متجر VELIX الإلكتروني",
    "url": "https://velix-eg.store/terms",
    "mainEntity": {
      "@type": "TermsOfService",
      "name": "شروط استخدام VELIX",
      "text": "شروط وأحكام استخدام متجر VELIX الإلكتروني"
    }
  };
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-amber-700/70 font-bold text-sm leading-relaxed">
                  VELIX تحتفظ بالحق في تعديل الشروط دي في أي وقت. التعديلات تدخل حيز التنفيذ فور نشرها على الصفحة.
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-black/60 font-bold text-sm mb-3">
                  لو عندك أي سؤال عن الشروط دي، اتصل بنا:
                </p>
